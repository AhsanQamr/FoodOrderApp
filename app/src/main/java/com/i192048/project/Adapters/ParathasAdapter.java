...
public class ParathasAdapter extends RecyclerView.Adapter<ParathasAdapter.ParathasViewHolder> {
    List<FoodModal> ls;
    Context context;
    ...
    public ParathasAdapter(List<FoodModal> ls, Context context) {
        this.ls = ls;
    ...
    @NonNull
    @Override
    public ParathasViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.foodview,parent,false);
        return new ParathasViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ParathasAdapter.ParathasViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class ParathasViewHolder extends RecyclerView.ViewHolder {
        ImageView food_image;
        TextView food_name,food_price;
        CardView cardView;
        ImageView likeOnCard;
        public ParathasViewHolder(@NonNull View itemView) {
            super(itemView);
