...
import com.i192048.project.Adapters.ParathasAdapter;
...
public class ParathasFragment extends Fragment {
    ...
    private void fetchData(){
        ...
        db.collection("Foods").document("Parathas").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    ParathasAdapter adapter = new ParathasAdapter(list,getContext());
